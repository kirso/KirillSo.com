			...
			<div tw="flex items-center">
				...
				>
					<path
						...
						fill="#CAFFF4"
					/>
					<path d="M300 360V540L450 630V540V450L300 360Z" fill="#CAFFF4" />
					<path
						d="M0 360V540L150 450V540V630L300 540V360L450 270V180V90L300 180V0L150 90V180L150 270L0 360Z"
						fill="#5DE4C7"
					/>
					<path d="M750 630L900 540L750 450V540V630Z" fill="#327567" />
					<path d="M450 270L300 360L450 450L600 360L450 270Z" fill="#327567" />
					<path d="M0 540L150 630V540V450L0 540Z" fill="#327567" />
					<path
						d="M600 720L750 630L675 585L600 540L450 630L300 540L150 630L300 720L150 810L300 900L450 810L600 900L750 810L600 720Z"
						fill="#327567"
					/>
					<path d="M450 90L300 1.04907e-05V180L450 90Z" fill="#327567" />
					<path d="M300 720L150 630V720V810L300 720Z" fill="#48AF99" />
					<path d="M600 540V360L450 450V540V630L600 540Z" fill="#48AF99" />
					<path d="M750 630L600 720L750 810V720V630Z" fill="#48AF99" />
					<path d="M600 0L450 90L600 180V0Z" fill="#48AF99" />
				</svg>
